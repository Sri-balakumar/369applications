              ...
              return (
                <View key={line.id || idx} style={styles.lineItem}>
                  ...
                  <View style={styles.lineDetails}>
                    ...
                    <Text style={styles.lineDetail}>Price: {currencySymbol} {price.toFixed(2)}</Text>
                    <Text style={styles.lineSubtotal}>{currencySymbol} {subtotal.toFixed(2)}</Text>
                  </View>
                </View>
              );
            })
        ...
        {isDraft && (
          <>
            <View style={{ marginVertical: 8 }}>
              <Button backgroundColor={COLORS.primaryThemeColor} title="Confirm Purchase" onPress={handleConfirm} loading={actionLoading} />
            </View>
            <View style={{ marginVertical: 4 }}>
              <Button backgroundColor="#F44336" title="Cancel" onPress={handleCancel} loading={actionLoading} />
            </View>
          </>
        )}
        {isCancelled && (
          <View style={{ marginVertical: 8 }}>
            <Button backgroundColor="#FF9800" title="Set to Draft" onPress={handleSetDraft} loading={actionLoading} />
          </View>
        )}
