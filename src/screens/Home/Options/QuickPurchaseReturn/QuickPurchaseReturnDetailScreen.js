    ...
    <SafeAreaView>
      ...
      <RoundedScrollContainer>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.fieldRow}>
            <View style={styles.fieldCol}><Text style={styles.fieldLabel}>Invoice Date</Text><Text style={styles.fieldValue}>{record.invoice_date || '-'}</Text></View>
            <View style={styles.fieldCol}><Text style={styles.fieldLabel}>Currency</Text><Text style={styles.fieldValue}>{Array.isArray(record.currency_id) ? record.currency_id[1] : currencySymbol}</Text></View>
          </View>
        </View>
            ...
            return (
              <View key={line.id || idx} style={styles.lineItem}>
                ...
                <View style={styles.lineDetails}>
                  ...
                  <Text style={styles.lineDetail}>Returned: {line.already_returned_qty || 0}</Text>
