          ...
          <>
            ...
            {details.lines.map((line) => (
              <View key={line.id} style={styles.tableRow}>
                ...
                <Text style={[styles.tableCell, styles.tableCellNum]}>{Number(line.price_unit).toFixed(3)}</Text>
                <Text style={[styles.tableCell, styles.tableCellNum]}>{Number(line.tax_amount).toFixed(3)}</Text>
                <Text style={[styles.tableCell, styles.tableCellNum]}>{Number(line.subtotal).toFixed(3)}</Text>
              </View>
            ))}
          </>
        )}
