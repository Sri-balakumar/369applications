              ...
              {products.length > 0 ? (
                products.map(p => (
                  <View key={p.id} style={styles.tableRow}>
                    ...
                    <Text style={[styles.cell, { width: 90, textAlign: 'right' }]}>{p.list_price.toFixed(2)}</Text>
                    <Text style={[styles.cell, { width: 80, textAlign: 'right' }]}>{p.cost.toFixed(2)}</Text>
                    {isSpare && (
                      <>
